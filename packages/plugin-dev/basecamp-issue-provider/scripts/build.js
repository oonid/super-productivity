...
// Load the repo-root .env (if present) so local builds can inject the SP-owned Basecamp OAuth
// client credentials without committing them. Does not override variables already in the env.
