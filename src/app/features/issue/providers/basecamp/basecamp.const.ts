...
// Register a Basecamp app at https://launchpad.37signals.com/integrations and set these.
// For installed/native apps the "secret" is not confidential (PKCE), so it ships in the build.
export const BASECAMP_LAUNCHPAD_CLIENT_ID = 'YOUR_BASECAMP_CLIENT_ID';
export const BASECAMP_LAUNCHPAD_CLIENT_SECRET = 'YOUR_BASECAMP_CLIENT_SECRET';
